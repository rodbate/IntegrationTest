...
public class InvokeDynamicCreator implements Opcodes{

    public static void main(final String[] args) throws Exception {
        final String outputClassName = "com/github/rodbate/Dynamic";
        try (FileOutputStream fos
                = new FileOutputStream(new File( "E:\\project\\github\\IntegrationTest\\target\\classes\\com\\github\\rodbate\\Dynamic.class"))) {
    ...
    public static byte[] dump(String outputClassName, String bsmName, String targetMethodDescriptor)
        ...
        MethodType mt = MethodType.methodType(CallSite.class, MethodHandles.Lookup.class, String.class,
                MethodType.class);
        Handle bootstrap = new Handle(Opcodes.H_INVOKESTATIC, "com/github/rodbate/InvokeDynamicCreator", bsmName,
